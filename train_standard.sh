...
# 2: base
# 3: base
python -u train.py --name chairs-base --stage chairs --validation chairs --gpus 0 1 2 3 --num_steps 1000000 --batch_size 16 --lr 0.0002 --image_size 352 480 --wdecay 0.0001
