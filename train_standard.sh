...
# 2: base
# 3: base
#python -u train.py --name chairs-base --stage chairs --validation chairs --gpus 0 1 2 3 --num_steps 1000000 --batch_size 16 --lr 0.0001 --image_size 352 480 --wdecay 0.0001
...
python -u train.py --name sintel-base --stage sintel --validation sintel --gpus 0 --num_steps 1000000 --batch_size 16 --lr 0.0001 --image_size 384 768 --wdecay 0.00001 --gamma=0.85
