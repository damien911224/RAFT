...
python -u train.py --name chairs-base --stage things --validation sintel --restore_ckpt checkpoints/raft-chairs.pth --gpus 0 --num_steps 1000000 --batch_size 16 --lr 0.000125 --image_size 400 720 --wdecay 0.0001
