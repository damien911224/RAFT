#!/bin/bash
mkdir -p checkpoints
python -u train.py --name chairs-second --stage chairs --validation chairs --gpus 0 1 --num_steps 400000 --batch_size 16 --lr 0.0002 --image_size 368 496 --wdecay 0.0001
