...
python -u train.py --name sintel-base --stage sintel --validation sintel --gpus 0 --num_steps 1000000 --batch_size 8 --lr 0.0002 --image_size 352 768 --wdecay 0.0001 --gamma=0.85
