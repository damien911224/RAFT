...
# 0: base
# 1: base
# 2: no_query_selection
# 3: base
python -u train.py --name chairs-base-no_query_selection --stage chairs --validation chairs --gpus 0 --num_steps 1000000 --batch_size 16 --lr 0.0002 --image_size 352 480 --wdecay 0.0001
