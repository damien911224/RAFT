...
# 0: base
# 1: E3_N256
# 2: E1_N256_O1_I12 (gamma)
# 3: attention_pos
python -u train.py --name chairs-base --stage chairs --validation chairs --gpus 0 --num_steps 1000000 --batch_size 16 --lr 0.0004 --image_size 352 480 --wdecay 0.0001
