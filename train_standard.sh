...
# 2: base
# 3: infill
python -u train.py --name chairs-base --stage chairs --validation chairs --gpus 0 1 2 --num_steps 1000000 --batch_size 6 --lr 0.0002 --image_size 352 480 --wdecay 0.0001
