#!/bin/bash
mkdir -p checkpoints
python -u train.py --name chairs-base-detach --stage chairs --validation chairs --gpus 0 1 --num_steps 1000000 --batch_size 64 --lr 0.0002 --image_size 352 480 --wdecay 0.0001
