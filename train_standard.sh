...
python -u train.py --name sintel-base --stage sintel --validation sintel --gpus 0 --num_steps 100000 --batch_size 16 --lr 0.0001 --image_size 384 768 --wdecay 0.00001 --gamma=0.85
