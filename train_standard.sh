...
# 2: corr
# 3: attention_pos
python -u train.py --name chairs-base-corr --stage chairs --validation chairs --gpus 0 --num_steps 1000000 --batch_size 16 --lr 0.0002 --image_size 352 480 --wdecay 0.0001
