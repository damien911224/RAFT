#!/bin/bash
mkdir -p checkpoints
python -u train.py --name chairs-base-dab-dense-detach-ms --stage chairs --validation chairs --gpus 0 --num_steps 1000000 --batch_size 16 --lr 0.0001 --image_size 352 480 --wdecay 0.0001
